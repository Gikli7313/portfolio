...
function ku(e, n, t, r) {
  ...
  typeof u == "object" && u !== null
    ? (l.context = _e(u))
    : ((u = de(n) ? xn : re.current), (l.context = qn(e, u))),
  ...
  return (
    ...
    e !== null && !ce
      ? ((n.updateQueue = e.updateQueue),
        ...
        (e.lanes &= ~l),
        Ye(e, n, l))
      : (F && t && ro(n), (n.flags |= 1), le(e, n, r, l), n.child)
  );
}
  ...
  return (
    ...
    e !== null && !ce
      ? ((n.updateQueue = e.updateQueue),
        ...
        (e.lanes &= ~l),
        Ye(e, n, l))
      : (F && r && ro(n), (n.flags |= 1), le(e, n, t, l), n.child)
  );
}
...
function Fa(e) {
  ...
  n !== null && ((e.alternate = null), Fa(n)),
    ...
    e.tag === 5 &&
      ((n = e.stateNode),
      n !== null &&
        (delete n[je], delete n[Vt], delete n[vu], delete n[Kf], delete n[Yf])),
    (e.stateNode = null),
    (e.return = null),
    (e.dependencies = null),
      ...
      return (
        ...
        l.$$typeof === void 0
          ? ((n.tag = 1),
            ...
            ku(n, r, e, t),
            (n = _u(null, n, r, !0, u, t)))
          : ((n.tag = 0), F && u && ro(n), le(null, n, l, t), (n = n.child)),
        n
      );
    case 16:
      r = n.elementType;
  ...
  switch (e.tag) {
    case 3:
      ...
      if (n.current.memoizedState.isDehydrated) {
        ...
        t !== 0 &&
          (Gu(n, t | 1), pe(n, W()), !(R & 6) && ((rt = W() + 500), vn()));
      }
      break;
    case 13:
      Ln(function () {
...
hs = _o;
ys = Ln;
var Nd = { usingClientEntryPoint: !1, Events: [Zt, Un, ll, ms, vs, _o] },
  ht = {
...
const Ld = ({ count: e }) =>
    se.jsxs("div", {
      className: "Viewer",
      children: [
        se.jsx("div", { children: "현재카운트:" }),
        se.jsx("h1", { children: e }),
      ],
    }),
  Td = ({ onClickButton: e }) => {
    const n = [-100, -10, -1, 1, 10, 100];
    return se.jsx("div", {
      className: "wrap",
      children: n.map((t) =>
        se.jsx(
          "button",
          { onClick: () => e(t), children: t > 0 ? `+${t}` : t },
          t
        )
      ),
    });
  },
  Rd = () => se.jsx("div", { className: "Even", children: "짝수" });
function Od() {
  const [e, n] = Vu.useState(0),
    t = (r) => {
      n(e + r);
    };
  return se.jsxs("div", {
    className: "App",
    children: [
      se.jsx("h1", { children: "카운터앱" }),
      se.jsxs("section", {
        children: [
          se.jsx(Ld, { count: e }),
          e % 2 === 0 ? se.jsx(Rd, {}) : null,
        ],
      }),
      se.jsx("section", { children: se.jsx(Td, { onClickButton: t }) }),
    ],
  });
}
ec(document.getElementById("root")).render(se.jsx(Od, {}));
